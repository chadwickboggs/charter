...
"
set -l CATALINA_OPTS_LOG " \
  -Dlogback-lib.env=filesystem \
  -DlocalLogging=true \
  -Dlogback-lib.env=filesystem \
"
set -l CATALINA_OPTS_NFOSS " \
